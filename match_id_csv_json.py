...
with open('/home/tajamul/scratch/DA/DATA/Dmaster_Data/c_view_data/c_view.json', 'r') as json_file:
...
csv_data = []
with open('/home/tajamul/scratch/DA/UDA/MRT/MRT-release-froc/csv_preds/d_master_adapt_cview.csv', 'r') as csv_file:
...
new_csv_filename = '/home/tajamul/scratch/DA/UDA/MRT/MRT-release-froc/csv_preds/d_master_adapt_cview1.csv'
