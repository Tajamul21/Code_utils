...
if __name__ == '__main__':
    data_root = '/home/tajamul/scratch/DA/Datasets/Voc_Data'
    src_dir_name = 'VOC_COMBINED'  # 'watercolor'  # 'sim10k'
    ...
    label_names = [label
                   ...
                   if len(label) > 0]
    categories_dict = {label: idx  for idx, label in enumerate(label_names)}  
